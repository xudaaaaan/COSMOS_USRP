...
class TxDco(object):
    ...
    def run(self,iq='iq', do_print=False):
        ...
        tx.bf.awv.setup(os.path.join(dirname,'lut/beambook/bf_tx_awv_' + tx.eder_version), 0.0, 0.0)
        tx.bf.idx.setup(os.path.join(dirname,'lut/beambook/bf_tx_awv_idx_' + tx.eder_version), 0.0)
        tx.set_beam(0)
        ...
        rx.disable()
        tx.bf.awv.setup(os.path.join(dirname,'lut/beambook/bf_tx_awv_' + tx.eder_version), freq, 0.0)
        tx.bf.idx.setup(os.path.join(dirname,'lut/beambook/bf_tx_awv_idx_' + tx.eder_version), freq)
