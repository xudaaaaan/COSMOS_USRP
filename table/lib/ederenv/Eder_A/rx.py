...
class Rx(object):
    ...
    def setup(self, freq, beam=None, bias_ctrl_rx=bias_ctrl_default):
        ...
        self.bf.awv.setup(os.path.join(dirname, 'lut/beambook/bf_rx_awv_' + self.eder_version), freq, 0.0)
        self.bf.idx.setup(os.path.join(dirname, 'lut/beambook/bf_rx_awv_idx_' + self.eder_version), freq)
