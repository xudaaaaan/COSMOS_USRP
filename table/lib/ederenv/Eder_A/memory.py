...
class Memory(object):
    ...
    tbls_awv = {
        'bf_tx_awv_ptr':         {'addr':0x0141, 'size':1,  'value':0x00},
        'bf_tx_awv_ptr_set':     {'addr':0x0142, 'size':1,  'value':0x00},
        'bf_rx_awv_ptr':         {'addr':0x01A1, 'size':1,  'value':0x00},
        'bf_rx_awv_ptr_set':     {'addr':0x01A2, 'size':1,  'value':0x00},
