...
if __name__ == "__main__":
	...
	eder = Eder(log_instance=info_logger, board_type='MB0')
        ...
        try:
            ...
            if args.unit_name == None:
                ...
                eder = Eder(log_instance=info_logger, unit_name=args.unit_name, board_type=args.board_type)
