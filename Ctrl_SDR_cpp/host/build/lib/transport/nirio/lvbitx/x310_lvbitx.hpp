...
#ifndef INCLUDED_X310_LVBITX_HPP
#define INCLUDED_X310_LVBITX_HPP

#include <uhd/transport/nirio/nifpga_lvbitx.h>

namespace uhd { namespace niusrprio {

class x310_lvbitx : public nifpga_lvbitx {
public:
    x310_lvbitx(const std::string& option);
...
#endif /* INCLUDED_X310_LVBITX_HPP */
